...
#       post awards_url, params: { award: { present_id: @award.present_id, signature: @award.signature, user_id: @award.user_id } }
#     end
...
#     patch award_url(@award), params: { award: { present_id: @award.present_id, signature: @award.signature, user_id: @award.user_id } }
