...
class JokesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joke" do
    assert_difference("Joke.count") do
      post jokes_url, params: { joke: { punchline: @joke.punchline, round_id: @joke.round_id, text: @joke.text } }
    end
  ...
  test "should update joke" do
    patch joke_url(@joke), params: { joke: { punchline: @joke.punchline, round_id: @joke.round_id, text: @joke.text } }
